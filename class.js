(function () {
  ...
  var FALLBACK_GAMES = [
    ...
    { slug: "fraction-frog", title: "Fraction Frog", path: "/fraction-frog.html", status: "live", description: "Hop to the matching fraction lily pad and build score streaks.", tags: ["math", "fractions"], theme: "break" },
    ...
    { slug: "connect-4", title: "Connect 4 Showdown", path: "/connect-4/", status: "live", description: "Two-player smartboard classic with an AI opponent — drop, stack, and line up four to win.", tags: ["strategy", "2 player"], theme: "logic" }
  ];
